package com.plcoding.MusicPlayer.ui.fragments
...
import com.plcoding.MusicPlayer.ui.viewmodels.SongViewModel
...
class SongFragment : Fragment(R.layout.fragment_song) {
    ...
    private fun subscribeToObservers(){
        ...
        songViewModel.curSongDuration.observe(viewLifecycleOwner){
            ...
            tvSongDuration.text = dateFormat.format(it-(60*1000*30))
        }
    }

    private fun setCurPlayerTimeToTextView(ms: Long){
        val dateFormat =SimpleDateFormat("mm:ss", Locale.getDefault())
        tvCurTime.text = dateFormat.format(ms-(60*1000*30))
    }
}